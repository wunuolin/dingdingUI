var _my$getSystemInfoSync = dd.getSystemInfoSync(),
  windowWidth = _my$getSystemInfoSync.windowWidth;

// var isV2 = my.canIUse('movable-view.onTouchStart');  //检测当前的属性在当前的版本是否可用(zfb api)
var isV2 = false
...
Component({
  ...
  methods: {
    setBtnWidth: function setBtnWidth() {
      ...
      dd.createSelectorQuery().select('.am-swipe-right-' + this.$id).boundingClientRect().exec(function (ret) {
